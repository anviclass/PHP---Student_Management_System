		...
		<div class="col-md-3">
			<div class="leftsidebar text-center">
				<ul>
					...
					<li><a href="dashboard.php?a=search">Search Student</a></li>
					<li><a href="dashboard.php?a=add">Add Student</a></li>
					<li><a href="dashboard.php?a=edit">Edit Student</a></li>
					<li><a href="dashboard.php?a=delete">Delete Student</a></li>
		...
		<div class="col-md-9">
			<div class="rightsidebar">
				...
				<?php
					...
					{
						include ('delete.php');
					}elseif($_REQUEST['a']=='report')
					{
						include ('report.php');
					}elseif($_REQUEST['a']=='setting')
					{
						include ('setting.php');
